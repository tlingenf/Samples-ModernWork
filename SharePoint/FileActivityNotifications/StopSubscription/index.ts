...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    try {
        ...
        const stopResponse = await axios.post(`https://manage.office.com/api/v1.0/${process.env.TenantId}/activity/feed/subscriptions/stop?contentType=Audit.SharePoint&PublisherIdentifier=${process.env.TenantId}`, {}, headerOptions);
